...
@test "approval provider records external plan approval and daemon resumes" {
...
[
  {
    ...
    "phase": "plan",
    "approver": "kris",
    "reason": "approved on github issue"
  }
]
JSON
  ...
  assert_output_contains '"approver": "kris"'
  assert_output_contains '"approver_source": "provider"'
}
