...
HCL
  ...
  run bach run --jobs 2 pipeline/deploy
  assert_success
...
HCL
  ...
  run bach run --jobs 4 group/release
  assert_success
...
HCL
  ...
  run bach run --jobs 6 group/release
  assert_success
  assert_output_contains "[group/release] group: pipeline/api, pipeline/web"
...
HCL
  ...
  run bach run --jobs 2 pipeline/release
  assert_failure
