...
checkpoint_file=""
prompt_file=""
dry_run_commands="go run ./cmd/bach --dry-run run shell/lint and go run ./cmd/bach --dry-run run shell/test"
gate_command="go run ./cmd/bach --log-only --force run group/gate"
acceptance_command=""
full_test_command=""
completed_marker=""
failed_marker=""
