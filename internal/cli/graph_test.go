...
`)
	...
	for _, want := range []graph.GraphEdge{
...
func graphNodeByName(nodes []graph.GraphNode, name string) *graph.GraphNode {
...
func hasGraphEdge(edges []graph.GraphEdge, want graph.GraphEdge) bool {
